...
import AuthUserSection from '../containers/AuthUserSection';
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="lg:hidden flex items-center space-x-2 md:space-x-3">
            ...
            <button
              ...
              className="flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 p-2 h-10 w-10 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-colors"
            >
